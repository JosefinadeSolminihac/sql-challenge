...
SELECT dept_manager.dept_no, departments.dept_name, employees.emp_no, employees.last_name, employees.last_name
FROM dept_manager
JOIN employees
...
SELECT COUNT(employees.last_name) AS "last name count", employees.last_name
FROM employees
